...
public:
    ...
    virtual NativeImage load(MyPTGuiNativeContext *context, const std::string &path, int maxSide) = 0;
};

class ImageIOStandardImageLoader final : public ImageLoader {
public:
    NativeImage load(MyPTGuiNativeContext *context, const std::string &path, int maxSide) override;
};
