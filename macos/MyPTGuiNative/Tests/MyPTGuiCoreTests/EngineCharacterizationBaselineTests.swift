...
final class EngineCharacterizationBaselineTests: XCTestCase {
    ...
    func testNativeCharacterizationEntryPointsRemainGreen() {
        ...
        XCTAssertEqual(myptgui_astro_geometry_characterization_self_test(), 1)
        XCTAssertEqual(myptgui_source_ownership_characterization_self_test(), 1)
        XCTAssertEqual(myptgui_typed_request_characterization_self_test(), 1)
        XCTAssertEqual(myptgui_pts_projection_characterization_self_test(), 1)
    }
}
