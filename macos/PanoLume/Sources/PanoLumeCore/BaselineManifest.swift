...
public enum BaselineManifestHarness {
    ...
    public static func summarize(manifestURL: URL) throws -> BaselineManifestSummary {
        ...
        return BaselineManifestSummary(
            ...
            cases: plans,
            notes: [
                "This command only plans parity work; it does not run Python or native stitching. Use PanoLumeRegression manifest run-native to execute native candidates.",
